...
| Phase 4 — measured service extraction                   | P4.1 implemented; its live rehearsal is tracked in issue #19. P4.2 in progress (Task 4 of 7); P4.3-P4.5 not started | see the P4.1-P4.5 table below                                              |
...
| P4.2 — Extract scans and asynchronous confirmation    | In progress (Task 4 of 7 done)                           | [p4.2-scans-async-confirmation.md](roadmap/p4.2-scans-async-confirmation.md) |
