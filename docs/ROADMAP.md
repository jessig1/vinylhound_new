...
| Phase 4 — measured service extraction                   | P4.1 implemented; its live rehearsal is tracked in issue #19. P4.2 complete (its staging rehearsal is a separate tracked issue); P4.3 Task 1 (decision record) and Task 2 (inventory) done; Task 3 in progress (closing the #9/#10 gate — #10 fixed, #9 written/plan-verified but apply blocked pending the maintainer), the transfer itself not started; Task 4 not started; P4.4-P4.5 not started | see the P4.1-P4.5 table below                                              |
...
| P4.3 — Separate platform delivery and state ownership | Task 1 (decision record, ADR-0031) and Task 2 (inventory, OPERATIONS.md) done; Task 3 in progress (#10 fixed, #9 written/plan-verified but apply blocked, actual transfer not started); Task 4 not started | [p4.3-platform-delivery.md](roadmap/p4.3-platform-delivery.md)               |
