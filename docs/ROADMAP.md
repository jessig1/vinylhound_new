...
| P4.4 — Verify benefits and costs against the monolith | Task 1 complete — matched P3.5 ingestion and fixed-provider-concurrency samples are published; Tasks 2-3 remain                                                                                                                                                                                                                                                                                                   | [p4.4-verify-benefits.md](roadmap/p4.4-verify-benefits.md)                   |
