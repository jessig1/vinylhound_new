...
| Phase 4 — measured service extraction                   | P4.1 implemented, core staging rehearsal now verified live (issue #19 down to one item: scaling, blocked on provider credentials/exec). P4.2 complete, core staging rehearsal now verified live (issue #29 down to one item: the authenticated pipeline smoke test, blocked on Clerk secret handling). P4.3 Tasks 1-3 done — all four Terraform roots transferred to [vinylhound-platform](https://github.com/jessig1/vinylhound-platform) (`production` deliberately plumbed but not cut over, gated on issue #8); Task 4 in progress — activation/deactivation, migration, independent service delivery, and a real staging rollback rehearsal (against live Aurora) all demonstrated live; only scaling and the authenticated smoke test remain; P4.4-P4.5 not started | see the P4.1-P4.5 table below                                              |
...
| P4.2 — Extract scans and asynchronous confirmation    | Complete; core staging rehearsal verified live 2026-09-23 (scan/core migrations 021/022 applied to real Aurora, services stable); issue #29 open for the remaining full-pipeline smoke test and rollback rehearsal                                                                                                                                                                                                                                                                                                             | [p4.2-scans-async-confirmation.md](roadmap/p4.2-scans-async-confirmation.md) |
| P4.3 — Separate platform delivery and state ownership | Tasks 1-3 done — all four Terraform roots (including `bootstrap`) transferred to [vinylhound-platform](https://github.com/jessig1/vinylhound-platform), `production` deliberately plumbed but not cut over (gated on issue #8); Task 4 in progress — activation/deactivation, migration, independent service delivery (issue #19 item 3 fixed and verified live), and a real staging rollback rehearsal against live Aurora (issue #29 item 4) all demonstrated live; scaling and the authenticated pipeline smoke test remain | [p4.3-platform-delivery.md](roadmap/p4.3-platform-delivery.md)               |
