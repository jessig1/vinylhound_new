...
| Phase 4 — measured service extraction                   | Complete at P4.4. Staging delivery, rollback, authenticated scan/confirm, and concurrent discovery callers were verified; P4.4 kept discovery with its single-replica constraint and kept the scan/core split. The unfinished private AI baseline moved to Phase 5. | see the P4.1-P4.4 table below                                              |
| Phase 5 — capture reliability and measured discovery    | Planned. Reliable hands-free capture leads; the private AI baseline, collection-aware suggestions, catalog enrichment, and an evidence-gated embeddings decision follow.                                                                                            | [phase-5-capture-ai-discovery.md](roadmap/phase-5-capture-ai-discovery.md) |
...
- Finish P3.5 after the selected product scope stabilizes. Run P4.1 before P4.2,
  ...
  staging extraction; P4.4 evaluates the final topology. The unfinished P4.5
  private AI baseline is now Phase 5 work and remains mandatory before public
  application usage or model/cost optimization.
...
| Milestone                                             | Status                                                                                                                                                                                                                                                                                                | File                                                                         |
| ----------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------- |
| P4.1 — Extract discovery first                        | Complete; discovery-only staging delivery/rollback and concurrent-caller coordination were verified in P4.3                                                                                                                                                                                           | [p4.1-extract-discovery.md](roadmap/p4.1-extract-discovery.md)               |
...
| P4.3 — Separate platform delivery and state ownership | Complete — all four Terraform roots and all deploy/deactivation writers are sole-owned by [vinylhound-platform](https://github.com/jessig1/vinylhound-platform); production activation/deactivation, independent service delivery, rollback, and the concurrent-caller staging workflow were verified | [p4.3-platform-delivery.md](roadmap/p4.3-platform-delivery.md)               |
| P4.4 — Verify benefits and costs against the monolith | Complete — Tasks 1-3 measurements support keeping discovery (single-replica constraint) and scan/core; the final topology audit and staging concurrent-caller workflow now pass end to end after P4.3 Task 4 completed                                                                                | [p4.4-verify-benefits.md](roadmap/p4.4-verify-benefits.md)                   |

## Phase 5 — capture reliability and measured discovery

Phase 5 starts from the [continuous capture improvement proposal](CONTINUOUS_CAPTURE_IMPROVEMENT_PLAN.md)
and P3.5/P4.4 measurements. See the [Phase 5 plan](roadmap/phase-5-capture-ai-discovery.md)
