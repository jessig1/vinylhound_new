...
| Phase 4 — measured service extraction                   | P4.1 implemented, core staging rehearsal now verified live (issue #19 partially closed, two items remain). P4.2 complete, core staging rehearsal now verified live (issue #29 partially closed, three items remain). P4.3 Task 1/Task 2 done; Task 3 in progress — `development` and `environment` (staging) transferred and verified live, `production`/`bootstrap` not started; Task 4 not started; P4.4-P4.5 not started | see the P4.1-P4.5 table below                                              |
