...
| Phase 4 — measured service extraction                   | P4.1 implemented, core staging rehearsal now verified live (issue #19 partially closed, two items remain). P4.2 complete, core staging rehearsal now verified live (issue #29 partially closed, three items remain). P4.3 Task 1/Task 2 done; Task 3 in progress — `development`/`environment` transferred and verified live, `production` has plumbing only (deliberately not cut over, gated on issue #8), `bootstrap` not started; Task 4 in progress — activation/deactivation and migration demonstrated live, a real worker crash-loop bug found and fixed live, independent delivery/scaling/rollback not yet demonstrated; P4.4-P4.5 not started | see the P4.1-P4.5 table below                                              |
...
| P4.3 — Separate platform delivery and state ownership | Task 1/Task 2 done; Task 3 in progress — `development`/`environment` transferred to [vinylhound-platform](https://github.com/jessig1/vinylhound-platform) and verified live, `production` plumbed but not cut over (gated on issue #8), `bootstrap` not started; Task 4 in progress — activation/deactivation and migration demonstrated live, a real worker crash-loop bug found and fixed live, independent delivery/scaling/rollback not yet demonstrated | [p4.3-platform-delivery.md](roadmap/p4.3-platform-delivery.md)               |
