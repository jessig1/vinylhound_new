...
output "confirmation_processing_queue_url" {
  value = aws_sqs_queue.confirmation_processing.url
}

output "confirmation_processing_dead_letter_queue_url" {
  value = aws_sqs_queue.confirmation_processing_dead_letter.url
}

output "confirmation_completion_queue_url" {
  value = aws_sqs_queue.confirmation_completion.url
}

output "confirmation_completion_dead_letter_queue_url" {
  value = aws_sqs_queue.confirmation_completion_dead_letter.url
}
...
output "kubernetes_runtime" {
  value = var.environment_active ? {
    ...
    confirmation_processing_queue_url = aws_sqs_queue.confirmation_processing.url
    confirmation_processing_dlq_url   = aws_sqs_queue.confirmation_processing_dead_letter.url
    confirmation_completion_queue_url = aws_sqs_queue.confirmation_completion.url
    confirmation_completion_dlq_url   = aws_sqs_queue.confirmation_completion_dead_letter.url
