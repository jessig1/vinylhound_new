...
output "confirmation_processing_queue_url" { value = aws_sqs_queue.confirmation_processing.url }
output "confirmation_processing_dead_letter_queue_url" { value = aws_sqs_queue.confirmation_processing_dlq.url }
output "confirmation_completion_queue_url" { value = aws_sqs_queue.confirmation_completion.url }
output "confirmation_completion_dead_letter_queue_url" { value = aws_sqs_queue.confirmation_completion_dlq.url }
